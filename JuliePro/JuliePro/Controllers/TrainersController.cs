...
namespace JuliePro.Controllers
{
    public class TrainersController : Controller
    {
        ...
        {
            var julieProDbContext = _context.Trainers.Include(t => t.Speciality).OrderBy(t => t.FirstName).ThenBy(t => t.LastName);
        ...
        public async Task<IActionResult> Create(Trainer trainer)
        {
            ...
            ViewData["SpecialityId"] = new SelectList(_context.Specialities, "Id", "Id", trainer.SpecialityId);
            return View(trainer);
        }
